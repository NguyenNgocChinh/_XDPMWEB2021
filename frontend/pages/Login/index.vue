<template>
    <v-card class="mx-auto mt-10" style="max-width: 500px">
        ...
        <div class="text-center mt-n-3">OR</div>
        <v-btn color="red" large block class="white--text my-3" @click="loginGG">Đăng nhập bằng Google</v-btn>
        <v-btn color="primary" large block class="white--text">Đăng nhập bằng Facebook</v-btn>
